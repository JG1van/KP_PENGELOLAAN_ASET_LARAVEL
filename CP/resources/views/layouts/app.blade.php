...
<body>
    ...
    <main class="main-content p-3">
        <div class="header d-flex justify-content-center align-items-center mb-4 position-relative">
            ...
            <!-- Judul di Tengah -->
            <h1 class="m-0 text-center">@yield('page_title', 'Dashboard')</h1>

            <!-- Info User di Kanan -->
            <a href="{{ route('pengaturan.profil.index') }}"
                class="tu-info text-black text-decoration-none position-absolute end-0">
